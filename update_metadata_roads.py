...
def upload_documents(login_url, username, password):
    ...
    try:
        ...
        for counter, cnt_name in enumerate(layers_to_be_created):
            ...
            layer_name = (iso + "_trs_roads_osm").lower()
